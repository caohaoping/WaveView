 ...
 * TODO
 */
public class WaveRquad extends View {

    private static final String TAG = WaveRquad.class.getSimpleName();
    ...
    public WaveRquad(Context context) {
        this(context, null);
    }

    public WaveRquad(Context context, @Nullable AttributeSet attrs) {
